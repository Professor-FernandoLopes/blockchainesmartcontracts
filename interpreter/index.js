// the result will be the final value into the stack
...
// função desta classe é interpretar código
class Interpreter {
// importante ter acesso a storage tree in order to store
constructor() {
this.state = {
programCounter: 0,
stack: [],
...
// we will need to interact with each instruction
...
console.log('Result of 10 ADD 5:', result);
